...
This is as-of January 7, 2026. Much of this will be automated in the future.
...
```zsh
curl -sL https://github.com/specstoryai/getspecstory/releases/download/v0.17.0/SpecStoryCLI_Darwin_arm64.tar.gz | shasum -a 256
curl -sL https://github.com/specstoryai/getspecstory/releases/download/v0.17.0/SpecStoryCLI_Darwin_x86_64.tar.gz | shasum -a 256
curl -sL https://github.com/specstoryai/getspecstory/releases/download/v0.17.0/SpecStoryCLI_Linux_arm64.tar.gz | shasum -a 256
curl -sL https://github.com/specstoryai/getspecstory/releases/download/v0.17.0/SpecStoryCLI_Linux_x86_64.tar.gz | shasum -a 256
```
...
Change the commit message to something like "Release v0.17.0" and click the "Commit changes" button to commit the changes to the Homebrew formula.
